...
ActiveRecord::Schema.define(version: 20170816004048) do

  create_table "appearances", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "title"
    t.string   "character"
    t.integer  "star_id"
  ...
  create_table "show_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "show_id"
